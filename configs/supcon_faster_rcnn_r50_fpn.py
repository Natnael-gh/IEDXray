...
custom_imports = dict(
    imports=['mmdet.models.roi_heads.standard_roi_head_supcon',
             'mmdet.models.roi_heads.contrastive_head'],
...
model = dict(
    roi_head=dict(
        ...
        contrastive=True,
        lambda_contrast=0.1,
        # DO NOT override bbox_head here
        # use the one from the base config
    )
)
# model = dict(
#     roi_head=dict(
