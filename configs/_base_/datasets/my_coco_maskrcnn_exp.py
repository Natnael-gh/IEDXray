...
data_root = r"C:\Users\Natnael\Desktop\Datasets\Explosives_segmentation_coco/"
...
train_dataloader = dict(
    ...
    dataset=dict(
        metainfo= dict(classes=('IED', 'Laptop Explosive', 'Pager Explosive', 'Mobile Explosive', 'Walkie-Talkie Explosive'), palette=[(220, 220, 60), (220, 20, 60), (119, 11, 32), (0, 0, 142), (0, 0, 230)]),
